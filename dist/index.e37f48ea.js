...
const controlServings = function(newServings) {
    ...
    // Render the new servings (in the view)
    // recipeView.render(model.state.recipe);
    _recipeViewJsDefault.default.update(_modelJs.state.recipe);
};
const controlAddBookmark = function() {
    // Add/remove bookmark in the state
...
},{"core-js/modules/web.immediate.js":"49tUX","./model.js":"Y4A21","./config.js":"k5Hzs","./views/recipeView.js":"l60JC","./views/searchView.js":"9OQAM","./views/resultsView.js":"cSbZE","./views/paginationView.js":"6z7bi","./views/bookmarksView":"4Lqzq","./views/addRecipeView.js":"i6DNj","regenerator-runtime/runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
...
},{"regenerator-runtime":"dXNgZ","./config.js":"k5Hzs","./helpers.js":"hGI1E","./views/addRecipeView.js":"i6DNj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dXNgZ":[function(require,module,exports) {
/**
...
const KEY = '56b2a937-b817-43d0-bc47-5ef0d7fd53a4';
...
},{"regenerator-runtime":"dXNgZ","./config":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"i6DNj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class View {
   ...
   * @param {boolean} [render = true] If false, create markup string instead of rendering the the DOM
   ...
   */ render(data, render = true) {
    ...
    update(data) {
        ...
        // Creating a new DOM stored in memory
        ...
        newElements.forEach((newEl, i)=>{
            ...
            if (!newEl.isEqualNode(curEl)) Array.from(newEl.attributes).forEach((attr)=>// Replacing the attributes in the curEl with the newEl attributes
...
class RecipeView extends _viewJsDefault.default {
    ...
    _generateMarkupIngredient(ing) {
      ...
      <li class="recipe__ingredient">
        ...
        <div class="recipe__quantity">${ing.quantity ? _fractyDefault.default(ing.quantity).toString() : ''}
        </div>
...
},{"./View.js":"5cUXS","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","fracty":"hJO4d"}],"hJO4d":[function(require,module,exports) {
...
},{"./View.js":"5cUXS","./previewView.js":"1FDQ6","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ddCAb","aenu9"], "aenu9", "parcelRequire3a11")
